...
public class ModuleController {
    ...
    public ResponseEntity<Object> saveModule (@PathVariable(value = "courseId") UUID courseId,
        ...
        BeanUtils.copyProperties(moduleDto, moduleModel); // Convertei de couserDto para courseMode
    ...
    public ResponseEntity<Object> updateModule(@PathVariable(value = "courseId") UUID courseId,
        ...
        log.debug("PUT updateModule moduleId updated {} ", moduleModel.getModuleId());
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModules (@PathVariable(value = "courseId") UUID courseId,
                                                            ...
                                                            @PageableDefault(page = 0, size = 10, sort = "moduleId", direction = Sort.Direction.ASC) // Paginação (page = 0 -> Pagina zero / sort = 10 -> É quant. de elem. por pagina / userId do menor id para o maior)
                                                                    Pageable pageable){
