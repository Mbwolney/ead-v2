...
public class LessonController {
    ...
    public ResponseEntity<Object> saveLesson (@PathVariable(value = "moduleId") UUID moduleId,
        ...
        BeanUtils.copyProperties(lessonDto, lessonModel); // Convertei de lessonDto para lessonModel
    ...
    public ResponseEntity<Object> updateLesson (@PathVariable(value = "moduleId") UUID moduleId,
        ...
        log.debug("PUT updateLesson lessonId updated {} ", lessonModel.getLessonId());
    ...
    public ResponseEntity<Page<LessonModel>> getAllLessons (@PathVariable(value = "moduleId") UUID moduleId,
                                                            ...
                                                            @PageableDefault(page = 0, size = 10, sort = "lessonId", direction = Sort.Direction.ASC) // Paginação (page = 0 -> Pagina zero / sort = 10 -> É quant. de elem. por pagina / userId do menor id para o maior)
                                                                        Pageable pageable){
